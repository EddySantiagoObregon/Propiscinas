...
<div class="logotipo">
		...
		<section class="articles">
			<article>
                            <input class="btn btn-primary" id="fecha" type="date">
                              <input autocomplete="off" style="display: inline-grid; width: 572px; padding-top: 1px;" placeholder="BUSQUEDA POR CÓDIGO DE PRODUCTO" type="text" id="txt_Buscar" class="form-control txt_Buscar">
    ...
    <tbody id="Container" class="Container">
                                 ...
                                 <div  id="botones"  style=" height: 60px;width:1214px; overflow:scroll; position:relative; overflow-x:scroll;
