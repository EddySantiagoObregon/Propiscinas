...
<div class="logotipo">
    ...
    width: 491px;
">  
                          <font style="    margin-left: 32px;" color="black">Producto a convertir</font>
                        <select style="  width: 322px;
    margin-left: 30px;" name="cb_ProductoConvertir" id="cb_ProductoConvertir" class="form-control">
                                <option value="0">Seleccione</option>
                                </select>
                        
                    
                </td>
            <td>             <svg style="    margin-top: 10px;
    font-size: 68px;
    border-width: medium;
    margin-left: 1‒;
    margin-left: 36px;"width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M10.146 4.646a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L12.793 8l-2.647-2.646a.5.5 0 0 1 0-.708z"/>
  <path fill-rule="evenodd" d="M2 8a.5.5 0 0 1 .5-.5H13a.5.5 0 0 1 0 1H2.5A.5.5 0 0 1 2 8z"/>
</svg></td>
            <td>                       
                           <font style="margin-left: 115px;" color="black">Infraestructura</font>
                         <select style="margin-left: 115px;" name="cb_Infraestructura" id="cb_Infraestructura" class="form-control">
                                <option value="0">Seleccione</option>
                                </select>
