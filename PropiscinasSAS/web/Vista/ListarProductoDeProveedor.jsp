<%-- 
    Document   : ListarProductoDeProveedor
    Created on : 27/08/2020, 04:57:49 PM
    Author     : PAULA
--%>
...
<html>
    <head>
        ...
        <title>ListarProveedorProduco</title>
        ...
        <script src="Js/ListarProductosDeProveedor.js" type="text/javascript"></script>
...
<div class="logotipo">
    ...
    <thead>
        <tr class="bg-info text-white" >
            ...
            <th style="background-color: #007bff;color: #fff;">Desactivar proveedor</th>       
