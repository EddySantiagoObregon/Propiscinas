	...
	<section class="main">
		<section class="articles">
			<article>
                            ...
                            <input autocomplete="off" style="display: inline-grid; width: 40%" type="text" id="txt_Buscar" class="form-control txt_Buscar" placeholder="BUSQUEDA POR NOMBRE O CÓDIGO DE PRODUCTO">
                ...
                <div class="modal-content">
                    ...
                    <input  type="hidden" id="sIdUnidad">
                      ...
                      <tr style="height: 40px;">
                        ...
                        <td><textarea onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" maxlength="150" name="txt_Observacion" id="txt_Observacion" class="form-control"  value="" required/></textarea></td>
