 ...
 private void listarProductoConvertir(HttpServletRequest request,HttpServletResponse response)
  ...
  private void CovertirProducto(HttpServletRequest request,HttpServletResponse response)
            throws ServletException, IOException
    {
        ...
        String obsrvacionDocumento =request.getParameter("observacionDocumento");
        Documento unDocumento = new Documento(numeroDocumento,unTipoDocumento,obsrvacionDocumento);
        Movimiento unMovimiento = new Movimiento(unaInfraestructura, unaTransaccion, numeroFactura,unDetalleProducto, fecha, 1,unaUnidadMedida ,unDocumento, unaInfraestructuraDespacho, observacion, estado,unUsuario);
        ...
        String numeroDocumentoo = request.getParameter("numeroDocumento");
        int idTipoDocumentoo = 1;
        TipoDocumento unTipoDocumentoo = new TipoDocumento();
        unTipoDocumentoo.setIdTipoDocumento(idTipoDocumentoo);
        String obsrvacionDocumentoo = request.getParameter("observacionDocumento");
